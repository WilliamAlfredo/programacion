...
//Ultima actualizacion 28 de septiembre de 2018
//Juego de X 0( tres en raya)  usando matrices
#include <iostream>//libreria obligatoria
#include <stdio.h>//contiene las declaraciones de las funciones
#include <stdlib.h>//contiene loa controles de procesos y gestion de memoria
...
int main() {
	...
	system ("pause");//para que el compilador se quede y no borre todo al instante
	return 0;//le devolvemos el control a la funcion main
}
...
void Intro_Yo (char c[3][3]){
	...
	do{
		do{
			...
			fflush (stdin);//antes de un scanf tiene que ir un fflush
			scanf ("%c",&aux);
		}while (aux < '1' || aux > '9');
